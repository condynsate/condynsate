...
from condynsate.core.dataclasses import (BodyState, JointState, LinkState)
...
class Body():
    ...
    **kwargs
    ...
    def __init__(self, client, path, **kwargs):
        ...
        self.links,self._link_ids,self.joints = self._build_links_and_joints()
    ...
    def apply_force(self, force, body=False):
        ...
        r = np.subtract(self.links[self._link_ids[-1]].center_of_mass, com)
